...
@section('content')
    <div class="container-fluid">
        <div class="page-head">
            <h4 class="mt-2 mb-2">Halaman Laporan Barang Keluar</h4>
        </div>
                ...
                <div class="col-lg-12 col-sm-12">
                    <div class="card m-b-30">
                        <div class="card-header bg-primary">
                            <h4 class="header-title text-white">Data Barang Keluar</h4>
                        </div>
        ...
        $(document).ready(function() {
            ...
            function fill_datatable(tahun = '', bulan = '') {
                var tabel = $('#tabelbarangkeluar').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('admin.laporanbarangkeluar') }}",
                        type: 'GET',
                        data: {
                            tahun: tahun,
                            bulan: bulan
            ...
            $("#filter").click(function() {
                ...
                if (tahun != '' && tahun != '') {
                    $('#tabelbarangkeluar').DataTable().destroy();
            ...
            $('#reset').click(function() {
                $('#tahun').val('');
                $('#bulan').val('');
                $('#tabelbarangkeluar').DataTable().clear();
                $('#tabelbarangkeluar').DataTable().destroy();
                fill_datatable();
            });
        });
